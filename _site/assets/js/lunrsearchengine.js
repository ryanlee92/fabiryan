...
var documents = [{
    ...
    "id": 7,
    "url": "/ios16-focus-mode/",
    "title": "iOS 16 포커스모드",
    "body": "2022/07/03 - 포커스 모드 만들고 모드마다 잠금화면이랑 홈 화면 설정할 수 있음 How to use?: It’s actually really simple! Add the rating in your YAML front matter. It also supports halfs: 12345678910---layout: posttitle:  Inception Movie author: johncategories: [ Jekyll, tutorial ]tags: [red, yellow]image: assets/images/11. jpgdescription:  My review of Inception movie. Actors, directing and more.  rating: 4. 5---"
    }, {
    "id": 8,
